                ...
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">harshithachen23@gmail.com</span>
                            <a href="mailto:harshithachen23@gmail.com" className="contact__button">
                        ...
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">+1 (636) 299-0696</span>
                            <a href="https://api.whatsapp.com/send?phone=16362990696&text=Hello Harshitha, I would like to connect!"
                                className="contact__button">
                                Write me <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>

                        {/* Messenger Contact - Removed */}
                    </div>
                </div>
