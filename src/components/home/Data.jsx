...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Harshitha Reddy
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className='home__description'>As a Full Stack Java Developer, I leverage my expertise in backend development, microservices, and cloud technologies to build scalable, high-performance applications with seamless data processing and integration. </p>
